...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("de.neuefische.CapStone.backend"))
    ...
    private ApiInfo getApiInfo() {
        return new ApiInfoBuilder()
                .title("Prof Beluga CapStone Project")
                .description("Sources at: https://github.com/AlexRSc/Capstone")
                .version("1.0")
                .build();
    }
}
